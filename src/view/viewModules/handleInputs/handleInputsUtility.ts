...
const prepareInputData = function prepareInputDataForChangeModel(
  thisView:SliderView,
...
//   const { panelSelectors } = eventData;
  const panelInputsData: PanelInputsData = {
    minMax: [panelSelectors.$minValueInput.val(), panelSelectors.$maxValueInput.val()],
    runnersValue: [
      panelSelectors.$runnerValueInput0.val(),
      panelSelectors.$runnerValueInput1.val(),
    ],
